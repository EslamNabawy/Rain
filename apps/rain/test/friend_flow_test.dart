...
class CountingFileTransferStore extends FileTransferStore {
  CountingFileTransferStore(super.database);

  int _loadByIdCount = 0;

  int get loadByIdCount => _loadByIdCount;

  void resetLoadByIdCount() {
    _loadByIdCount = 0;
  }
