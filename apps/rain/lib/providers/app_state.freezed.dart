...
mixin _$PeerConnectionView {
 ...
 String get peerId; Session? get session; String? get localDetail; Object? get error; bool get actionBusy; bool get disconnecting; int? get updatedAt;
...
@override
int get hashCode => Object.hash(runtimeType,peerId,session,localDetail,const DeepCollectionEquality().hash(error),actionBusy,disconnecting,updatedAt);

@override
String toString() {
  return 'PeerConnectionView(peerId: $peerId, session: $session, localDetail: $localDetail, error: $error, actionBusy: $actionBusy, disconnecting: $disconnecting, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String peerId, Session? session, String? localDetail, Object? error, bool actionBusy, bool disconnecting, int? updatedAt
});
...
/// Create a copy of PeerConnectionView
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? peerId = null,Object? session = freezed,Object? localDetail = freezed,Object? error = freezed,Object? actionBusy = null,Object? disconnecting = null,Object? updatedAt = freezed,}) {
...
as String?,error: freezed == error ? _self.error : error ,actionBusy: null == actionBusy ? _self.actionBusy : actionBusy // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String peerId,  Session? session,  String? localDetail,  Object? error,  bool actionBusy,  bool disconnecting,  int? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PeerConnectionView() when $default != null:
return $default(_that.peerId,_that.session,_that.localDetail,_that.error,_that.actionBusy,_that.disconnecting,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String peerId,  Session? session,  String? localDetail,  Object? error,  bool actionBusy,  bool disconnecting,  int? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _PeerConnectionView():
return $default(_that.peerId,_that.session,_that.localDetail,_that.error,_that.actionBusy,_that.disconnecting,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String peerId,  Session? session,  String? localDetail,  Object? error,  bool actionBusy,  bool disconnecting,  int? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _PeerConnectionView() when $default != null:
return $default(_that.peerId,_that.session,_that.localDetail,_that.error,_that.actionBusy,_that.disconnecting,_that.updatedAt);case _:
  return null;
...
class _PeerConnectionView extends PeerConnectionView {
  const _PeerConnectionView({required this.peerId, this.session, this.localDetail, this.error, this.actionBusy = false, this.disconnecting = false, this.updatedAt}): super._();
...
/// Create a copy of PeerConnectionView
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? peerId = null,Object? session = freezed,Object? localDetail = freezed,Object? error = freezed,Object? actionBusy = null,Object? disconnecting = null,Object? updatedAt = freezed,}) {
