...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | `VoiceCallRuntime` has too many responsibilities. | [[Architecture Stabilization Epic]] | Runtime Responsibility Split | TASK-001 | [ ] Partial 2026-06-08 | Classifier/media adapters, terminal-session policy, room helper policy, state mapping/reset policy, call-start preflight, and reconnect grace state are extracted; next extract Firebase room reconciliation and lock coordination behind characterization tests. |
