...
| SCN-UPDATE-001 | Remote Config policy is stale after release | LoadingPolicy -> RemotePolicyOutdated | ASSUMP-004 | FG-006 | `force_update_service_test.dart` and settings tests cover stale policy UI. | Add release artifact evidence that deployed Remote Config manifest matches commit/version. | BLK-004, BLK-006 | Partially Covered |
