...
| Phase 5: Navigation Readiness | P0 | Next | Phase 3, Phase 4 | Protected routes only exist after auth/runtime readiness. | Settings/search/friend routes cannot render protected content while loading. |
