...
| Phase 3: Startup State Machine | P0 | Next | Phase 1, Phase 2 | Startup phases are explicit and repeatable. | Bootstrap/auth/identity/runtime/presence/router readiness transitions are tested. |
