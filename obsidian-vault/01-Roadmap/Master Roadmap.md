...
| Phase 4: Global Splash Architecture | P0 | Next | Phase 3 | Main UI cannot render before startup completes. | No navigation/runtime widgets/call overlays appear during startup loading. |
