...
| Phase 3: Voice Call Runtime Decomposition | P0 | Partial local proof 2026-06-08 | Phases 1-2, [[VoiceCallRuntime Refactor]], [[Call State Machine]] | Call command, media, lock, room reconciliation, terminal reconciliation, peer UI projection, renderer failure authority, error classification, preflight, and reconnect ownership are split or explicitly bounded. | Characterization tests pass before and after extraction; 2026-06-08 focused state/room/terminal/reconnect/preflight coordinator tests passed locally. Full room/lock/command extraction and device proof remain. |
