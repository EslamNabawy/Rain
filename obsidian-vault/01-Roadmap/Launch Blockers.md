...
| Diagnostics can hide root cause or expose private data. | P1 | TASK-004, TASK-014 | 5 days | Diagnostics classify failure cause while redacting sensitive payloads. | Sanitized diagnostics tests pass. |
