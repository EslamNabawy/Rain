...
- `VoiceCallRuntime` still owns public command orchestration, full call/file conflict policy, lock/lease orchestration, and some local end-state sequencing. Continue Phase 3 with command and lease orchestration extraction before calling SAR-001 mitigated.
