...
- 2026-06-04 update warning artifact proof: `Build Rain Apps` run 26963049075 passed for pushed `dev` SHA `f1904e72f1c16773700f0bfa6bcc8ac0fcd7706d`, including hard release gate, Android v7/v8-v9 APK builds, Windows demo portable build, and pre-release `rain-test-109-1`. Remote Config deployment is still required before old installed `1.0.6+7` clients can see the `1.0.7+8` required-update policy.
